  ...
  extension RichTextFormatToolbarBase {
    ...
    func alignmentPicker(
      ...
      if !config.alignments.isEmpty {
        ...
        .frame(idealWidth: 150, maxWidth: 300)
      }
    }
    ...
    func styleToggleGroup(
      ...
      if !config.styles.isEmpty {
        ...
        .frame(minWidth: 100, idealWidth: 120, maxWidth: 200)
      }
    }

    @ViewBuilder
    func otherMenuToggleGroup(
      for context: RichEditorState
    ) -> some View {
      if !config.otherMenu.isEmpty {
        RichTextOtherMenu.ToggleGroup(
          context: context,
          styles: config.otherMenu
        )
      }
    }
